...
- **Implementation is underway in roadmap order.** Phases 1–3 (`init`,
  `check`, `list`, `status`, `create`, `commit`) are landed. Do not scaffold
  later phases without an explicit request.
