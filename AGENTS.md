...
- **Implementation is underway in roadmap order.** Phases 1–4 (`init`,
  `check`, `list`, `status`, `create`, `commit`, `export`) are landed. Do not
  scaffold later phases without an explicit request.
